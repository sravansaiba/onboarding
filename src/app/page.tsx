...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    if (userStr) {
      try {
        ...
        setIsLoggedIn(true);
        // Extract role name (or type) — use 'name' or 'type' as per your data
        setUserRole(user.role?.name || user.role?.type || null);
      } catch (e) {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-orange-50 via-white to-orange-50">
      ...
      {/* Hero Section */}
      <div style={{ backgroundImage: 'url("/bg2.jpg")', backgroundSize: 'cover', backgroundPosition: 'center' }} className="container mx-auto px-4 py-35 md:py-35">
